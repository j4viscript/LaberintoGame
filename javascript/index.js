...
function start(){
    ...
    mob2 = new Cuadrado(350, 0, 50,50, 'white');
...
function paint(){
    ...
    //images
    ctx.drawImage(player, player1.x, player1.y, 90,90);
    //mobs
...
function update(){
    mobs1.forEach(mob =>  {
        ...
        if(stop){
            ...
            counter % 2 == 0 ? mob.y += mobSpeed + generateRandomInteger(1) : mob.y += mobSpeed + generateRandomInteger(20);
            counter ++;
        }
    });
    mobs2.forEach(mob =>  {
